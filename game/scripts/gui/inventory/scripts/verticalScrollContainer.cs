...
function Vscg_UpBTN::onMouseDown(%this)
{
    ...
    %this.scrollUp();
    %this.button.setBitmap(%this.button.DownImage);
}
...
{
   %this.button.setBitmap(%this.button.HoverImage);
}
...
{
   %this.button.setBitmap(%this.button.normalImageCache);
}
...
function VerticalScrollCtrl::addButton(%this, %guiControl, %object, %handler, %data)
{
	...
	while (%itemCount > 0)
	{
	    ...
	    if (isObject(%temp))
	    {
            ...
            %type $= "guiIconButtonCtrl" || %type $= "GuiBitmapButtonCtrl")
            {
                %buttons[%k] =  %temp;
...
/// </summary>
/// <param name="profile">Profile for the scroll container.  Default is InventorySunkenContainerProfile</param>
...
function createVerticalScrollContainer(%profile)
{
    ...
    %containerProfile = (%profile !$= "" ? %profile : "InventorySunkenContainerProfile");
    if ( %containerProfile $= "" )
	...
	%upButton = new GuiBitmapButtonCtrl()
	{
		...
		useMouseEvents="1";
		isLegacyVersion="0";
		bitmap="scripts/gui/assets/gui/northArrowNormal.png";
		HoverImage="scripts/gui/assets/gui/northArrowHover.png";
		DownImage="scripts/gui/assets/gui/northArrowDown.png";
		InactiveImage="scripts/gui/assets/gui/northArrowNormal.png";
		    normalImageCache="scripts/gui/assets/gui/northArrowNormal.png";
	};
	...
	%downButton = new GuiBitmapButtonCtrl()
	{
		canSaveDynamicFields="0";
		isContainer="0";
		Profile="GuiTransparentProfile";
		...
		useMouseEvents="1";
		isLegacyVersion="0";
		bitmap="scripts/gui/assets/gui/southArrowNormal.png";
		HoverImage="scripts/gui/assets/gui/southArrowHover.png";
		DownImage="scripts/gui/assets/gui/southArrowDown.png";
		InactiveImage="scripts/gui/assets/gui/southArrowNormal.png";
		    normalImageCache="scripts/gui/assets/gui/southArrowNormal.png";
	};
